            ...
            <header className="border-b border-zinc-200 dark:border-zinc-900 bg-white/80 dark:bg-zinc-950/80 backdrop-blur-md sticky top-0 z-40 px-6 py-4 flex items-center justify-between">
                <div className="flex items-center gap-8">
                    <div className="flex items-center gap-3">
                        ...
                        <span className="font-extrabold tracking-tight bg-gradient-to-r from-zinc-800 to-zinc-550 dark:from-zinc-550 dark:to-zinc-400 bg-clip-text text-transparent">AI Everywhere</span>
                    </div>
